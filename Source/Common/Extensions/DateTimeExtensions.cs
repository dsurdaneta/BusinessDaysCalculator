...
public static class DateTimeExtensions
{
    ...
    /// </returns>
    public static bool IsWeekend(this DateTime currentDateTime) => currentDateTime.DayOfWeek == DayOfWeek.Saturday || currentDateTime.DayOfWeek == DayOfWeek.Sunday;
    ...
    /// </returns>
    public static bool IsAWeekDay(this DateTime currentDateTime) => currentDateTime.DayOfWeek > DayOfWeek.Sunday && currentDateTime.DayOfWeek < DayOfWeek.Saturday;
}
